...
from rl_base.modules import ActorCritic
from rl_base.modules.rnd import RandomNetworkDistillation
from rl_base.storage import RolloutStorage
from rl_base.utils import string_to_callable
...
class PPO:
    ...
    def update(self):  # noqa: C901
        ...
        for batch in generator:
            # Distillation shares rollout storage with an extra privileged-actions tensor.
            # PPO ignores that trailing field when present.
            if len(batch) == 13:
                (
                    obs_batch,
                    critic_obs_batch,
