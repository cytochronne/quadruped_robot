...
from rl_base.utils import split_and_pad_trajectories
...
class RolloutStorage:
    ...
    def add_transitions(self, transition: Transition):
        ...
        if self.training_type == "rl":
            # Some pure PPO policies do not provide privileged action targets.
            # Keep the buffer well-formed by falling back to sampled actions.
            if transition.privileged_actions is not None:
                self.privileged_actions[self.step].copy_(transition.privileged_actions)
            else:
                self.privileged_actions[self.step].copy_(transition.actions)
